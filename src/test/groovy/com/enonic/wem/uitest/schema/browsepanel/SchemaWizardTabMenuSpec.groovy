    ...
    extends BaseGebSpec
{
    ...
    def "GIVEN Content Type Wizard opened, data typed WHEN tab-menu button clicked THEN a list of items with content type's name present"()
    {
        ...
        ContentTypeWizardPanel wizard = schemaBrowsePanel.clickToolbarNew().selectKind( ctype.getSchemaKindUI().getValue() ).typeData(
            ctype );
