...
public class SleepWaitHelper
{
	 ...
	 */
	public static void waitUntilElementEnabled(final TestSession testSession, final By by) throws TestFrameworkException
	{
		try
		{
	...
	public static boolean waitAndCheckAttrValue(WebDriver webDriver, final WebElement element, final String attributeName, final String attributeValue,
			long timeout)
	{
