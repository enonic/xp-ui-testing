...
public class BrowserUtils
{
     ...
     * @param testSession
     */
    public static void createDriverAndOpenBrowser( final TestSession testSession )
        throws IOException
    {
    ...
    private static Capabilities createDesiredCapabilities( final TestSession testSession )
    {
        ...
        logger.info( "DesiredCapabilities for RemoteWebDriver uses:  platform:" + platform + " browser:" + browserName + "version:" +
                         browserVersion + " created" );
        return capability;
    }
