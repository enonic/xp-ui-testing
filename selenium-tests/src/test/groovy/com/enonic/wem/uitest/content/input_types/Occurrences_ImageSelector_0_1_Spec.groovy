    ...
    extends Base_InputFields_Occurrences
{
    ...
    def "GIVEN saving of 'Image Selector-content' (0:1) without options WHEN content opened for edit THEN no one selected options present on page and content is valid "()
    {
        ...
        and: "just created content without images is valid"
