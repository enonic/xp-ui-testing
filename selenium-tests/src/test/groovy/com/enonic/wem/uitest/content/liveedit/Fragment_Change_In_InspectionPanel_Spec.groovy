    ...
    extends BaseContentSpec
{
    ...
    def "GIVEN existing site with single fragment is opened WHEN one more fragment has been created THEN two fragments should be present in the dropdown list"()
    {
        given:
