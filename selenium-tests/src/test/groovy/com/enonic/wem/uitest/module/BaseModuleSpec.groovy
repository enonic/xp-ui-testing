    ...
    extends BaseGebSpec
{
    ...
    @Shared
    String FIRST_MODULE_URL = "mvn:com.enonic.xp.ui-testing/first-module/5.1.0-SNAPSHOT";

    @Shared
    String SECOND_MODULE_URL = "mvn:com.enonic.xp.ui-testing/second-module/5.1.0-SNAPSHOT";

    @Shared
    String THIRD_MODULE_URL = "mvn:com.enonic.xp.ui-testing/third-module/5.1.0-SNAPSHOT";

    @Shared
    String FOURTH_MODULE_URL = "mvn:com.enonic.xp.ui-testing/fourth-module/5.1.0-SNAPSHOT";
    ...
    @Shared
    String TEST_MODULE_URL = "mvn:com.enonic.xp.ui-testing/test-module/5.1.0-SNAPSHOT";
}
